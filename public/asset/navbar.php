      ...
      <div class="col-2 col-sm-3 col-md-3 col-lg-8">
        ...
        <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
          <ul id="siteNav" class="site-nav medium center hidearrow">
            ...
            <?php if (isset($_SESSION['id_costumer'])): ?>
              <li class="lvl1 parent dropdown"><a href="#">Riwayat Transaksi <i class="anm anm-angle-down-l"></i></a></li>
              <li class="lvl1 parent dropdown"><a href="#">Pembayaran <i class="anm anm-angle-down-l"></i></a></li>
              <li class="lvl1 parent dropdown"><a href="#">Topup <i class="anm anm-angle-down-l"></i></a></li>
            <?php endif; ?>
