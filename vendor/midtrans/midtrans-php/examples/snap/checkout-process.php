                      ...
                      <?php if (!isset($_GET['kupon'])) {
                        if ($_POST['kupon']!='null') { ?>
                          <?php if ($kupon->jenis_kupon=='persen'){ ?>
                            <td>Rp.<?= number_format($total_order); ?>;- (Potongan Kupon <?= $kupon->total_diskon; ?>%)</td>
                            <?php $_SESSION['harga_baru'] = $total_order; ?>
                          <?php } else { ?>
                            <td>Rp.<?= number_format($total_order); ?>;- (-Diskon Rp.<?= number_format($kupon->total_diskon); ?>)</td>
                            <?php $_SESSION['harga_baru'] = $total_order; ?>
                          <?php } ?>
                        <?php } else { ?>
          ...
          <div class="your-payment">
            ...
            <div class="payment-method">
              ...
              <form name="myform" action="add-pembayaran.php" method="post">
                ...
                <div id="accordion" class="payment-section">
                  <textarea name="detail_address" rows="8" cols="80" required style="resize:none;"></textarea>
                </div>
...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-cplDPO1YZt_pmxoj"></script>
